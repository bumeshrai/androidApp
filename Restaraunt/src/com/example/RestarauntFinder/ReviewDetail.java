package com.example.RestarauntFinder;
...
import com.example.RestarauntFinder.data.Review;
...
public class ReviewDetail extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        name.startAnimation(AnimationUtils.loadAnimation(this, R.anim.scalar));
